...
- **Compatibility Notes:** Template repo filename normalization (APP.details.md / APP.ROADMAP.md); no execution or governance behavior changes.
...
- **Platform Version:** 0.3.7.0 (MAJOR=0, MINOR=3, MICRO=7, PATCH=0), the canonical string updated with every TODO completion.
