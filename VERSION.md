...
- **Full Version:** 0.3.8.6
- **Previous Version:** 0.3.8.5
- **Bump Type:** Patch
- **Triggering TODO:** TODO-075 (Privileged CI Force-Alignment Executor)
- **Bumped By:** TODO-075 (Privileged CI Force-Alignment Executor)
- **Created At:** 2026-02-09T02:59:19Z
- **Compatibility Notes:** CI-based privileged force alignment executor added (workflow_dispatch)
...
- **Platform Version:** 0.3.8.6 (MAJOR=0, MINOR=3, MICRO=8, PATCH=6)
